                ...
                <div class="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                    ...
                    <form action="{{ route('contact.send') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="name" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all" placeholder="Masukkan nama anda" required>
                        </div>
                        <div class="mb-6">
                            <label class="block text-slate-700 font-bold mb-2">Pesan</label>
                            <textarea name="message" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all h-32" placeholder="Tulis pesan anda disini..." required></textarea>
                        </div>
                        <button type="submit" class="w-full py-4 bg-green-600 hover:bg-green-700 text-white font-bold rounded-xl transition-colors shadow-lg shadow-green-500/30 flex items-center justify-center gap-2">
